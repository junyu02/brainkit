...
const tasks = [
  { name: 'memory interface', cwd: HERE, args: ['--test', './test-memory-read.mjs', './test-memory-ops.mjs', './test-memory-synthesis.mjs', './test-memory-mcp.mjs', './test-memory-records.mjs', './test-memory-retrieval.mjs', './test-memory-ingestion.mjs', './test-memory-sync-state.mjs', './test-memory-health.mjs'] },
  { name: 'test-brain-http', cwd: HERE, args: ['--test', './test-brain-http.mjs'] },
  { name: 'test-brain-sunday', cwd: HERE, args: ['--test', './test-brain-sunday.mjs'] },
  {
    name: 'test-harvest-runtime',
    cwd: HERE,
    args: ['--test', './test-harvest-runtime.mjs'],
  },
  {
  ...
  {
    name: 'test-brain-query',
    cwd: HERE,
    args: ['--test', './test-brain-query.mjs'],
  },
  {
    name: 'test-publish',
    cwd: HERE,
